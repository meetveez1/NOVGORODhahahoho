...
Телеграм-бот для семантического поиска по текстам книг и ответов на вопросы по их содержанию. Реализован на базе RAG-подхода: текст книги разбивается на фрагменты, каждый фрагмент превращается в векторное представление, а при запросе система находит наиболее близкие по смыслу фрагменты и формирует ответ.
...
| LLM для ответов | OpenRouter (модель по выбору) |
...
- `war_and_peace.txt` — «Война и мир», Л.Н. Толстой
- `crime_and_punishment.txt` — «Преступление и наказание», Ф.М. Достоевский

Скачать можно с сайта [lib.ru](http://lib.ru) или [Викитеки](https://ru.wikisource.org).

---

### Пример 1 — Поиск фрагментов (`/search`)

**Запрос:**
```
/search первый бал Наташи Ростовой
```

**Ответ бота:**
```
🔍 Найдено 3 фрагмента по запросу «первый бал Наташи Ростовой»:

━━━━━━━━━━━━━━━━━━
📗 Война и мир | Часть третья | Строки 4021–4048
Сходство: 89%

«Наташа была так счастлива, как никогда ещё в жизни. Она была на той высшей
ступени счастия, когда человек делается вполне добр и хорош...»

━━━━━━━━━━━━━━━━━━
📗 Война и мир | Часть третья | Строки 3998–4020
Сходство: 84%

«Денисов, нагнувшись к Наташе, что-то говорил ей, и граф Безухов,
краснея, поправлял перчатку...»

━━━━━━━━━━━━━━━━━━
📗 Война и мир | Часть третья | Строки 4049–4071
Сходство: 79%

«Андрей подошёл к Наташе и попросил её руки на вальс. То трепетное
выражение, которое оживляло её лицо...»
```

---

### Пример 2 — Вопрос по тексту (`/ask`)

**Запрос:**
```
/ask Почему Раскольников решился на убийство старухи-процентщицы?
```

**Ответ бота:**
```
💬 Ответ на вопрос: «Почему Раскольников решился на убийство?»

Раскольников совершил убийство под влиянием своей теории о «необыкновенных
людях», которые имеют право переступать через нравственный закон ради высшей
цели. Он считал себя таким человеком — способным взять на себя право решать
судьбы других. Кроме того, его подтолкнули крайняя нищета и беспомощность
близких.

📌 Цитаты из текста:

«Преступление и наказание» | Часть первая | Строки 812–835:
«...Тварь ли я дрожащая или право имею... Вот в чём вопрос!»

«Преступление и наказание» | Часть первая | Строки 601–624:
«Все люди делятся на два разряда: на низших... и на собственно людей,
то есть имеющих дар или талант сказать в среде своей новое слово...»
```

---

### Пример 3 — Книга не загружена

**Запрос:**
```
/search встреча Мастера и Маргариты
```

**Ответ бота:**
```
📭 По запросу «встреча Мастера и Маргариты» ничего не найдено
в загруженных книгах.

Проверь список книг: /books
Загрузи книгу — отправь .txt файл прямо в чат.
```
...
├── books/              # Тестовые книги в формате .txt
│   ├── war_and_peace.txt
